...
public class Menu extends JPanel {
    ...
    private void init() {
        ...
        add(scroll);
        addTitle("Main");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.HOME, "Dashboard"));
        addTitle("Pages");
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.VIEW_LIST, "Barang"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MONETIZATION_ON, "Transaksi"));
        addMenuItem(new ModelMenuItem(GoogleMaterialDesignIcon.MAIL_OUTLINE, "Laporan"));
